...
- Version affichée dans l'application : **v0.9.0**.
- Version des données : **0.9.0**.
- Cache PWA/service worker : **deauville-planning-0.9.0**.
- Les assets `index.html`, CSS, JS et manifest sont versionnés en `?v=0.9.0`.
...
- Les anciennes clés localStorage v0.2/v0.3/v0.4/v0.5 sont migrées vers la clé v0.9 afin de ne pas perdre le planning personnel existant.
