const C="deauville-planning-2.2.13";
const A=["./","./index.html","./style.css?v=2.1.0","./app.js?v=2.1.0","./v21.js?v=2.1.0","./v22.js?v=2.2.13","./data.json","./manifest.json?v=2.1.0","./icon.svg"];
