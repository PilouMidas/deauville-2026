/* Deauville 2026 · V3.0.20 — fiche film depuis toutes les séances */
(function(){
  'use strict';
  ...
  function ensureSessionFilmLink(id){
    ...
    b.type='button';b.className='v320FilmLink';b.textContent='Voir la fiche du film';b.setAttribute('aria-label','Voir la fiche du film');
  ...
  if(typeof oldSession==='function')window.openSession=function(id,...rest){oldSession.apply(this,[id,...rest]);[0,30,100,250,500].forEach(t=>setTimeout(()=>ensureSessionFilmLink(id),t));};
  ...
  style.textContent='.v320FilmLink{display:inline-flex!important;align-items:center;margin:8px 0 2px;padding:8px 12px;border:1px solid rgba(201,162,39,.8);border-radius:999px;background:rgba(201,162,39,.12);color:inherit;font:inherit;font-size:13px;font-weight:700;cursor:pointer;white-space:nowrap}';
